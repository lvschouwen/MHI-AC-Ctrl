...
void discovery_start_outdoor(const MhiGroupAvty* avty);  // the six outdoor rows, available on avty's units (fork #29), go out one per loop() pass after the unit rows
