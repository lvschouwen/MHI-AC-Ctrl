...
#endif
#ifndef HA_NAME_REMOTE
#define HA_NAME_REMOTE "Remote"                     // the last change came from the IR remote (fork #39)
#endif
#ifndef HA_NAME_IU_FAN_SPEED
#define HA_NAME_IU_FAN_SPEED "Indoor fan speed"     // OpData/IU-FANSPEED; 8 = HI POWER (fork #39)
#endif
